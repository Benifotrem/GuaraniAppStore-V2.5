<x-guest-layout>
    <div class="mb-6 text-center">
        <h2 class="text-2xl font-bold text-emerald-900">Iniciar Sesión</h2>
        <p class="text-gray-700 text-sm mt-2">Accede a tu cuenta de {{ config('app.name') }}</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            @if (Route::has('password.request'))
                <a class="text-sm text-emerald-600 hover:text-emerald-700 font-semibold"
